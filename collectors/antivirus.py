...
class AntivirusCollector(BaseCollector):
    """Collector for antivirus artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['ProgramData/Microsoft/Windows Defender', 'Windows/Logs/MpCmdRun.log', 'Windows/System32/winevt/Logs/Microsoft-Windows-Windows Defender%4Operational.evtx']
