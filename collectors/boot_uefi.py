...
class BootUEFICollector(BaseCollector):
    """Collector for boot_uefi artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/System32/config/BCD', 'Windows/System32/bootstat.dat', 'Windows/Boot']
