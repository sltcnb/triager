...
class CloudDropboxCollector(BaseCollector):
    """Collector for cloud/dropbox artifacts."""
    
    category = 'cloud_dropbox'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Roaming/Dropbox/*.db', 'Users/*/AppData/Local/Dropbox/logs']
