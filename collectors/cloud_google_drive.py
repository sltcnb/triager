...
class CloudGoogleDriveCollector(BaseCollector):
    """Collector for cloud/google_drive artifacts."""
    
    category = 'cloud_google_drive'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Local/Google/DriveFS']
