...
class CredentialsCollector(BaseCollector):
    """Collector for credentials artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/System32/config/SAM', 'Windows/System32/config/SECURITY', 'Windows/System32/config/SYSTEM', 'Users/*/AppData/Roaming/Microsoft/Credentials', 'Users/*/AppData/Roaming/Microsoft/Protect']
