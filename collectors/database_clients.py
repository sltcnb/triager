...
class DatabaseClientsCollector(BaseCollector):
    """Collector for database_clients artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Roaming/Microsoft/SQL Server Management Studio', 'Users/*/AppData/Roaming/DBeaverData', 'Users/*/.pgadmin']
