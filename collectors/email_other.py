...
class EmailOtherCollector(BaseCollector):
    """Collector for email/other artifacts."""
    
    category = 'email_other'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Local/Comms/Unistore/mail*.db']
