"""
EmailOutlook collector for ForensicHarvester.

Collects email/outlook artifacts.
"""
...
class EmailOutlookCollector(BaseCollector):
    """Collector for email/outlook artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/Documents/*.pst', 'Users/*/Documents/*.ost', 'Users/*/AppData/Local/Microsoft/Outlook/*.pst', 'Users/*/AppData/Local/Microsoft/Outlook/*.ost', 'Users/*/AppData/Roaming/Microsoft/Outlook/*.nk2']
