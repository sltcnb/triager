...
class ETWDiagnosticsCollector(BaseCollector):
    """Collector for etw_diagnostics artifacts."""
    
    category = 'etw_diagnostics'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/System32/LogFiles/WMI', 'Windows/System32/winevt/Logs/Microsoft-Windows-DiagTrack-Listener']
