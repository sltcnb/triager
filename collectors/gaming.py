...
class GamingCollector(BaseCollector):
    """Collector for gaming artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Roaming/Steam', 'Program Files (x86)/Steam', 'Users/*/AppData/Local/EpicGamesLauncher', 'Users/*/AppData/Roaming/Battle.net']
