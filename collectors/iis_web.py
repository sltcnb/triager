...
class IISWebCollector(BaseCollector):
    """Collector for iis_web artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/System32/LogFiles', 'Windows/System32/inetsrv/config/applicationHost.config', 'inetpub/logs']
