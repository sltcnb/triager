...
class NetworkCollector(BaseCollector):
    """Collector for network artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/System32/drivers/etc/hosts', 'Windows/System32/drivers/etc/lmhosts', 'Windows/System32/drivers/etc/networks', 'Windows/System32/drivers/etc/protocol', 'Windows/System32/drivers/etc/services', 'Windows/Debug/NetSetup/NetSetup.log', 'Windows/inf/netlogon.inf']
