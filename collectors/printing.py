...
class PrintingCollector(BaseCollector):
    """Collector for printing artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/System32/spool', 'Users/*/AppData/Roaming/Microsoft/Windows/Printer']
