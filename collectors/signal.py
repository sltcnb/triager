...
class SignalCollector(BaseCollector):
    """Collector for messaging/signal artifacts."""
    
    category = 'messaging_signal'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Roaming/Signal/config.json', 'Users/*/AppData/Roaming/Signal/sql/db.sqlite', 'Users/*/AppData/Roaming/Signal/logs']
