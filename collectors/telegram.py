...
class TelegramCollector(BaseCollector):
    """Collector for messaging/telegram artifacts."""
    
    category = 'messaging_telegram'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Roaming/Telegram Desktop/tdata', 'Users/*/AppData/Roaming/Telegram Desktop/logs']
