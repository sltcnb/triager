...
class USBDevicesCollector(BaseCollector):
    """Collector for usb_devices artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Windows/inf/setupapi.dev.log', 'Windows/inf/setupapi.setup.log', 'Windows/inf/setupapi.offline.log']
