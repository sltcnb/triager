...
class VirtualizationCollector(BaseCollector):
    """Collector for virtualization artifacts."""
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Local/Microsoft/Windows Containers', 'Users/*/.docker', 'ProgramData/Microsoft/Windows/HyperV', '*.vhd', '*.vhdx', '*.vmdk', '*.vdi']
