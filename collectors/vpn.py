...
class VPNCollector(BaseCollector):
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['Users/*/AppData/Roaming/OpenVPN', 'Users/*/AppData/Local/WireGuard', 'Users/*/AppData/Local/Cisco/Cisco AnyConnect Secure Mobility Client', 'ProgramData/Cisco/Cisco AnyConnect Secure Mobility Client']
