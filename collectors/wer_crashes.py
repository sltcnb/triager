...
class WERCrashesCollector(BaseCollector):
    """Collector for wer_crashes artifacts."""

    category = 'wer_crashes'
    ...
    def collect(self) -> CollectionResult:
        ...
        artifact_paths = ['ProgramData/Microsoft/Windows/WER/ReportArchive', 'ProgramData/Microsoft/Windows/WER/ReportQueue', 'Users/*/AppData/Local/CrashDumps', 'Windows/MEMORY.DMP', 'Windows/Minidump']
